...
func (in *GithubStatus) DeepCopyInto(out *GithubStatus) {
	*out = *in
	if in.ProductionDeployID != nil {
		in, out := &in.ProductionDeployID, &out.ProductionDeployID
		*out = new(int64)
		**out = **in
	}
	if in.PullRequestDeployID != nil {
		in, out := &in.PullRequestDeployID, &out.PullRequestDeployID
